...
\frame {
  ...
  Примитивные типы:
  \begin{itemize}
    \item \textbf{целое} число (int, long, unsigned int, ...)
    \item \textbf{дробное} число (float, double)
    \item \textbf{символ} (char)
  \end{itemize}

  \vspace{1cm}
  Составные типы:
  \begin{itemize}
    \item \textbf{массивы} (array)
    \item \textbf{объекты} (string, list, dict/map, ...)
  \end{itemize}
}
