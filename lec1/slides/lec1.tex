...
\begin{document}
  ...
  \section{Обзор развития вычислительных систем}
    \frame {
      ...
      \begin{center}
        \includegraphics[scale=0.3]{pictures/Von_Neumann_architecture.png}
      \end{center}
    }
    ...
    \frame {
      ...
      Системы состоят из подсистем (layers / levels)
      \begin{center}
    ...
    \frame {
      ...
      \begin{itemize}
        \item системный (например операционная система)
        \begin{itemize}
          ...
          \item стек протоколов TCP/IP
            ...
            \end{itemize}
        \end{itemize}
        \item прикладной (например веб-браузер)
          \begin{itemize}
            \item GUI
              \begin{itemize}
                \item Кнопка...
              \end{itemize}
            \item Интерпретатор JavaScript
            \item HTTP-клиент
          \end{itemize}
      \end{itemize}
      \begin{center}
        \includegraphics[scale=0.4]{pictures/programs-as-seen-by-users.png}
      \end{center}
    }
